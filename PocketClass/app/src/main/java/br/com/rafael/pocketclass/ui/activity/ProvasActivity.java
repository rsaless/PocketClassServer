...
import br.com.rafael.pocketclass.ui.fragment.DetalhesProvaFragment;
import br.com.rafael.pocketclass.ui.fragment.ListaProvasFragment;
...
public class ProvasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (estaNoModoPaisagem()) tx.replace(R.id.frame_secundario, new DetalhesProvaFragment());
        tx.commit();
    }
